              ...
              <article class="task--card">
                ...
                <section class="task--content" aria-label="task content">
                  <div class="task--title-wrapper">
                    ...
                    <p class="task--description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas, eaque.</p>
                  </div>
                  <!-- progress -->
                ...
                <footer class="task--footer">
                  <ul class="task--assignees" aria-label="Zugewiesene Personen">
                    <li class="assignee">
                      <abbr class="assignee--initials" title="Anna Müller">AM</abbr>
                    </li>
                  </ul>
